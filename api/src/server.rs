...
pub async fn main() {
    ...
    let router = Router::new()
        ...
        .push(Router::with_path("api/video/<video_id>/<user_id>").post(create_comment))
        .push(Router::with_path("api/video/<video_id>/comment/").get(get_comment))
        .push(Router::with_path("api/video/<video_id>/comment/<id>").delete(delete_comment))
